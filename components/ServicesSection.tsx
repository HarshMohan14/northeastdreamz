    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-3xl mx-auto leading-relaxed mb-4">
            ...
            >
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-semibold text-brand-primary mb-3 section-title">
                      {service.title}
                    </h3>
