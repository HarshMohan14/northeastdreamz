      ...
      >
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center space-x-3 px-8 py-4 bg-brand-accent text-white font-semibold text-base md:text-lg rounded-xl premium-button shadow-lg hover:shadow-xl transition-all"
          >
